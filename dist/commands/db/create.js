...
exports.create = cli_1.Command
    .make('create', { databases }, ({ databases }) => index_1.initializeUrl.pipe(effect_1.Effect.andThen(createDbs(databases)), effect_1.Effect.map(effect_1.Array.map(db => effect_1.Effect.promise(() => db.info()))), effect_1.Effect.flatMap(effect_1.Effect.all), effect_1.Effect.tap(core_1.logJson)))
