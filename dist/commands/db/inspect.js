...
exports.inspect = cli_1.Command
    .make('inspect', { databases }, ({ databases }) => index_1.initializeUrl.pipe(effect_1.Effect.andThen(dbs_info_1.CouchDbsInfoService.post(databases)), effect_1.Effect.tap(console_1.logJson)))
