...
export const ls = Command
    .make('ls', {}, Effect.fn(() => initializeUrl.pipe(Effect.andThen(getAllDbsInfo()), Effect.map(Array.map(getDbDisplay)), Effect.map(getDisplayDictByPid), Effect.tap(Console.table))))
