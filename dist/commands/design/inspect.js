...
exports.inspect = cli_1.Command
    .make('inspect', { database, designs }, ({ database, designs }) => index_1.initializeUrl.pipe(effect_1.Effect.andThen((0, effect_1.pipe)(designs, effect_1.Array.map(getViewData(database)), effect_1.Effect.all)), effect_1.Effect.tap(core_1.logJson)))
