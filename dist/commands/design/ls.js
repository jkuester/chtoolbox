...
const printDesignDocNames = (dbName) => getDesignDocNames(dbName)
    .pipe(effect_1.Effect.flatMap(effect_1.Console.log));
...
const printAllDesignDocNames = effect_1.Effect
    ...
    .pipe(effect_1.Effect.flatMap(dbNames => (0, effect_1.pipe)(effect_1.Array.map(dbNames, getDesignDocNames), effect_1.Effect.all, effect_1.Effect.map(effect_1.Array.zip(dbNames)), effect_1.Effect.map(getDisplayDict))), effect_1.Effect.flatMap(effect_1.Console.log));
