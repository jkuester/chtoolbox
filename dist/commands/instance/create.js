...
const console_color_1 = require("../../libs/console-color");
...
Instance(s) started!
  ...
  Username: ${(0, effect_1.pipe)('medic', (0, console_color_1.color)('green'))}
  Password: ${(0, effect_1.pipe)('password', (0, console_color_1.color)('green'))}

`)
    .pipe(effect_1.Effect.andThen((0, effect_1.pipe)(ports, effect_1.Array.map(local_network_1.getLocalIpUrl), effect_1.Array.map((0, console_color_1.color)('blue')), effect_1.Array.zip(names), effect_1.Array.map(([url, name]) => effect_1.Console.log(`${name} - ${url}`)), effect_1.Effect.all)));
