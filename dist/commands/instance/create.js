...
const printInstanceInfo = (names) => (ports) => (0, console_1.clearThen)(effect_1.Console
    .log(`
Instance(s) started!
...
exports.create = cli_1.Command
    ...
    .pipe(effect_1.Effect.andThen(createChtInstances(names, version)), effect_1.Effect.andThen((0, console_1.clearThen)(effect_1.Console.log('Starting instance(s)...'))), effect_1.Effect.andThen(startChtInstances(names)), effect_1.Effect.tap(setLocalIpSSLCerts(names)), effect_1.Effect.flatMap((0, exports.printInstanceInfo)(names))))
