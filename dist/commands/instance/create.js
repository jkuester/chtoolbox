...
export const create = Command
    ...
    .pipe(Effect.andThen(createChtInstances(names, version)), Effect.andThen(clearThen(Console.log('Starting instance(s)...'))), Effect.andThen(startChtInstances(names)), Effect.tap(setLocalIpSSLCerts(names)), Effect.flatMap(printInstanceTable)))
