...
exports.monitor = cli_1.Command
    .make('monitor', { interval, trackDirSize }, ({ interval, trackDirSize }) => (0, effect_1.pipe)(index_1.initializeUrl, effect_1.Effect.andThen(monitor_1.MonitorService), effect_1.Effect.tap(monitor => (0, effect_1.pipe)(monitor.getCsvHeader(trackDirSize), printCsvRow, effect_1.Effect.andThen(effect_1.Effect.repeat(monitorData(monitor, interval, trackDirSize), { until: () => false }))))))
