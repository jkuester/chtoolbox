...
cli(process.argv)
    .pipe(effect_1.Effect.provide(platform_node_1.NodeContext.layer), effect_1.Effect.provide(platform_node_1.NodeHttpClient.layer), effect_1.Effect.provide(environment_1.EnvironmentServiceLive), effect_1.Effect.provide(couch_1.CouchServiceLive), effect_1.Effect.provide(compact_1.CouchCompactServiceLive), effect_1.Effect.provide(node_system_1.CouchNodeSystemServiceLive), effect_1.Effect.provide(dbs_info_1.CouchDbsInfoServiceLive), effect_1.Effect.provide(design_docs_1.CouchDesignDocsServiceLive), effect_1.Effect.provide(design_info_1.CouchDesignInfoServiceLive), effect_1.Effect.provide(design_1.CouchDesignServiceLive), effect_1.Effect.provide(view_1.CouchViewServiceLive), effect_1.Effect.provide(compact_2.CompactServiceLive), effect_1.Effect.provide(local_disk_usage_1.LocalDiskUsageServiceLive), effect_1.Effect.provide(monitor_2.MonitorServiceLive), effect_1.Effect.provide(warm_views_1.WarmViewsServiceLive), platform_node_1.NodeRuntime.runMain);
