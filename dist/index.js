...
cli(process.argv)
    .pipe(effect_1.Effect.provide(compact_2.CompactService.Default), effect_1.Effect.provide(monitor_2.MonitorService.Default), effect_1.Effect.provide(local_disk_usage_1.LocalDiskUsageService.Default), effect_1.Effect.provide(purge_2.PurgeService.Default), effect_1.Effect.provide(warm_views_1.WarmViewsService.Default), effect_1.Effect.provide(replicate_1.ReplicateService.Default), effect_1.Effect.provide(active_tasks_2.CouchActiveTasksService.Default), effect_1.Effect.provide(compact_1.CouchCompactService.Default), effect_1.Effect.provide(node_system_1.CouchNodeSystemService.Default), effect_1.Effect.provide(dbs_info_1.CouchDbsInfoService.Default), effect_1.Effect.provide(design_docs_1.CouchDesignDocsService.Default), effect_1.Effect.provide(design_info_1.CouchDesignInfoService.Default), effect_1.Effect.provide(design_1.CouchDesignService.Default), effect_1.Effect.provide(purge_1.CouchPurgeService.Default), effect_1.Effect.provide(view_1.CouchViewService.Default), effect_1.Effect.provide(pouchdb_1.PouchDBService.Default), effect_1.Effect.provide(cht_client_1.ChtClientService.Default.pipe(effect_1.Layer.provide(platform_node_1.NodeHttpClient.layerWithoutAgent.pipe(effect_1.Layer.provide(platform_node_1.NodeHttpClient.makeAgentLayer({ rejectUnauthorized: false })))))), effect_1.Effect.provide(environment_1.EnvironmentService.Default), effect_1.Effect.provide(platform_node_1.NodeContext.layer), platform_node_1.NodeRuntime.runMain);
