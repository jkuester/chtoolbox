...
const CouchServicesLayer = compact_1.CouchCompactServiceLive.pipe(effect_1.Layer.merge(node_system_1.CouchNodeSystemServiceLive), effect_1.Layer.merge(dbs_info_1.CouchDbsInfoServiceLive), effect_1.Layer.merge(design_docs_1.CouchDesignDocsServiceLive), effect_1.Layer.merge(design_info_1.CouchDesignInfoServiceLive), effect_1.Layer.merge(design_1.CouchDesignServiceLive), effect_1.Layer.merge(view_1.CouchViewServiceLive), effect_1.Layer.provide(couch_1.CouchServiceLive.pipe(effect_1.Layer.provide(platform_node_1.NodeHttpClient.layer), effect_1.Layer.provide(environment_1.EnvironmentServiceLive))));
cli(process.argv)
    .pipe(effect_1.Effect.provide(platform_node_1.NodeContext.layer), effect_1.Effect.provide(environment_1.EnvironmentServiceLive), effect_1.Effect.provide(compact_2.CompactServiceLive.pipe(effect_1.Layer.provide(CouchServicesLayer))), effect_1.Effect.provide(monitor_2.MonitorServiceLive.pipe(effect_1.Layer.provide(CouchServicesLayer), effect_1.Layer.provide(local_disk_usage_1.LocalDiskUsageServiceLive.pipe(effect_1.Layer.provide(platform_node_1.NodeContext.layer))))), effect_1.Effect.provide(warm_views_1.WarmViewsServiceLive.pipe(effect_1.Layer.provide(CouchServicesLayer))), platform_node_1.NodeRuntime.runMain);
