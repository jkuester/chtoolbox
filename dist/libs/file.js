...
export const isDirectoryEmpty = Effect.fn((dirPath) => FileSystem.FileSystem.pipe(Effect.flatMap(fs => fs
    .exists(dirPath)
    .pipe(Effect.map(Boolean.not), Effect.filterOrElse(dirNotExists => dirNotExists, () => fs
