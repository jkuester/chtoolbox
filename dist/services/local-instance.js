...
class LocalInstanceService extends effect_1.Effect.Service()('chtoolbox/LocalInstanceService', {
    effect: serviceContext.pipe(effect_1.Effect.map(context => ({
        ...
        setSSLCerts: (instanceName, sslType) => ensureUpgradeServiceExists(instanceName)
            .pipe(effect_1.Effect.andThen((0, docker_1.upCompose)(upgradeSvcProjectName(instanceName))), effect_1.Effect.andThen(getPortForInstance(instanceName)), effect_1.Effect.tap(waitForInstance), effect_1.Effect.andThen((0, file_1.createTmpDir)()), effect_1.Effect.tap(writeSSLFiles(sslType)), effect_1.Effect.flatMap(copySSLFilesToNginxContainer(instanceName)), effect_1.Effect.andThen((0, docker_1.restartComposeService)(instanceName, NGINX_SVC_NAME)), effect_1.Effect.mapError(x => x), effect_1.Effect.provide(context), effect_1.Effect.scoped),
