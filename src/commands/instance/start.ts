...
const directory = Options
  ...
  .pipe(
    ...
    Options.withDescription(
      'The local directory containing the instance data. This should ONLY be specified when recovering an instance '
      + 'which has had all its containers removed, but the data directory still exists. Provide the path to the PARENT '
      + 'directory of the instance data (the one containing the directory with your instance name).'
    ),
    Options.optional,
  );
